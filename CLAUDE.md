...
If you're the agent reading this: you are the keeper of this workspace. Start by reading `.jez/about.md` so you know who you're working for and how they like to work. Then, three habits matter most.
...
The point of all three is compounding: every session should start better-informed than the last, because the one before it wrote down what it learned. A capable agent in a loop is only as good as the memory it tends.
