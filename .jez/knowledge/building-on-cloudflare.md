...
- **[cf-astro-starter](https://github.com/jezweb/cf-astro-starter)** (public, MIT): a simple, fast **content website**: static pages on Cloudflare. The right choice for a brochure site, a landing page, a small-business site. Its README covers setup and deploy; `MODULES.md` lists the optional pieces.
...
4. **Go live.** Follow the starter's going-live docs (vite-flare-starter ships `GOING-LIVE.md`; cf-astro-starter's README covers deploy): a free `.workers.dev` URL in minutes, then point your own domain when ready.
